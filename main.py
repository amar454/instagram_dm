...
# URL for Famous Birthdays page (for example, top influencers)
...
# Find influencer names and Instagram links (adjust according to page structure)
influencers = soup.find_all('a', class_='profile-link')

for influencer in influencers:
    name = influencer.get_text()
    instagram_handle = influencer['href'] if 'instagram' in influencer['href'] else None
    if instagram_handle:
        print(f'Influencer: {name}, Instagram: {instagram_handle}')
